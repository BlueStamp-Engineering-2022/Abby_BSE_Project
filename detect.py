...
# WARNING: if you try running in Thonny or another IDE outside the right virtual environment and directory, you may
...
def run(model: str, camera_id: int, width: int, height: int, num_threads: int,
  ...
  while cap.isOpened():
    ...
    # Print each detected object's class_name (i.e. person, cat, keyboard), score (how confident the prediction is),
    ...
    text = cv2.putText(image, fps_text, text_location, cv2.FONT_HERSHEY_PLAIN,
