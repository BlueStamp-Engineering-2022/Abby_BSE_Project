...
This project uses TensorFlow Lite to train a machine learning model that can identify moles and melanoma. With just a Raspberry Pi computer and camera module, a variety of software can be employed to differentiate between cancerous and benign skin lesions. Read more about the process below.
